...
public class Drive extends Subsystem {
    ...
    private Drive() {
        ...
        mYawOffset = gyro.getYaw();
        mRollOffset = gyro.getRoll();
        mPitchOffset = gyro.getPitch();
        readGyro();
        readModules();
    ...
    protected synchronized void readGyro() {
        ...
        mPeriodicIO.heading = Rotation2d.fromDegrees(gyro.getYaw() - mYawOffset);
        mPeriodicIO.roll = Rotation2d.fromDegrees(gyro.getRoll() - mRollOffset);
        mPeriodicIO.pitch = Rotation2d.fromDegrees(gyro.getPitch() - mPitchOffset);
    }

...
public abstract class SwerveModule extends Subsystem {
    ...
    private final StatusSignal<Double> mDriveMotorVelocitySignalValue;
    private final StatusSignal<Double> mDriveMotorPositionSignalValue;
    private final StatusSignal<Double> mSteeringMotorPositionSignalValue;
    private final StatusSignal<Double> mDriveMotorClosedLoopErrorSignalValue;
    private final StatusSignal<Double> mSteeringMotorClosedLoopErrorSignalValue;
    private final StatusSignal<Double> mSteeringMotorVelocitySignalValue;

    private final StatusSignal<Double> mSteeringTemperatureSignalValue;

    private final StatusSignal<Double> mDriveTemperatureSignalValue;
    ...
    public SwerveModuleState getPreviewedState() {
        return new SwerveModuleState(
            getDriveVelocity(),
            kDriveMotorCoefficient * StatusSignal.getLatencyCompensatedValue(mDriveMotorPositionSignalValue, mDriveMotorVelocitySignalValue),
            Rotation2d.fromRadians((StatusSignal.getLatencyCompensatedValue(mSteeringMotorPositionSignalValue, mSteeringMotorVelocitySignalValue) * kSteerPositionCoefficient) - mTalonOffset.getRadians()) );
    }
    ...
    public StatusSignal<Double> getDrivePositionSignalValue() {
        return mDriveMotorPositionSignalValue;
    }

    public StatusSignal<Double> getDriveMotorClosedLoopErrorSignalValue() {
        return mDriveMotorClosedLoopErrorSignalValue;
    }

    public StatusSignal<Double> getDriveVelocitySignalValue() {
        return mDriveMotorVelocitySignalValue;
    }

    public StatusSignal<Double> getSteerPositionSignalValue() {
        return mSteeringMotorPositionSignalValue;
    }

    public StatusSignal<Double> getSteerVelocitySignalValue() {
        return mSteeringMotorVelocitySignalValue;
    }

    public StatusSignal<Double> getSteerErrorSignalValue() {
